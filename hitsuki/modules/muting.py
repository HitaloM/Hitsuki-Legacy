...
#    Copyright (C) 2019-2020 Akito Mizukito (Hitsuki Network Development)
...
from hitsuki.modules.helper_funcs.chat_status import bot_admin, user_admin, is_user_admin, can_restrict, is_user_ban_protected
