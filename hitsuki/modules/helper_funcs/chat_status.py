    ...
    def promote_rights(update, context, *args, **kwargs):
        if update.effective_chat.get_member(context.bot.id).can_promote_members:
            ...
            update.effective_message.reply_text(
                languages.tl(update.effective_message, "I can't promote/demote people here! "
...
def user_admin(func):
    ...
    def is_admin(update, context, *args, **kwargs):
        ...
        if user and is_user_admin(update.effective_chat, user.id):
            ...
            update.effective_message.reply_text(
                languages.tl(update.effective_message, "These are not the admin, Who gave the order to me?"))
...
def user_admin_no_reply(func):
    ...
    def is_admin(update, context, *args, **kwargs):
        ...
        if user and is_user_admin(update.effective_chat, user.id):
            ...
            context.bot.answer_callback_query(update.callback_query.id, languages.tl(update.effective_message,
                                                                                     "You are not admin in this group!"))
