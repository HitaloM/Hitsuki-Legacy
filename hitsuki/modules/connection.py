            ...
            if (
                ...
                if connection_status:
                    ...
                    if history:
                        ...
                        if (
                            number == 1
                            and connect_chat != history2
                            and connect_chat != history3
                        ):
                            history1 = connect_chat
                            number = 2
                        elif (
                            number == 2
                            and connect_chat != history1
                            and connect_chat != history3
                        ):
...
CONNECT_CHAT_HANDLER = CommandHandler(
    ["connect", "connection"], connect_chat, allow_edited=True, pass_args=True
)
DISCONNECT_CHAT_HANDLER = CommandHandler(
    "disconnect", disconnect_chat, allow_edited=True
)
ALLOW_CONNECTIONS_HANDLER = CommandHandler(
    "allowconnect", allow_connections, allow_edited=True, pass_args=True
)
