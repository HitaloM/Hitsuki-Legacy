    ...
    for text in split_text:
        if filter_list == tl(update.effective_message, "<b>Kata daftar hitam saat ini di {}:</b>\n").format(chat_name):
            send_message(update.effective_message,
                         tl(update.effective_message, "Tidak ada pesan daftar hitam di <b>{}</b>!").format(chat_name),
    ...
    if len(words) > 1:
        ...
        if len(to_blacklist) == 1:
            ...
            send_message(update.effective_message, tl(update.effective_message,
                ...
                len(to_blacklist), chat_name), parse_mode=ParseMode.HTML)
...
def unblacklist(update, context):
    ...
    if len(words) > 1:
        ...
        if len(to_unblacklist) == 1:
            ...
            send_message(update.effective_message, tl(update.effective_message,
                                                      "<code>{}</code> Pemicu dihapus dari daftar hitam di <b>{}</b>!").format(
            ...
            send_message(update.effective_message,
                         tl(update.effective_message, "Pemicu <code>{}</code> dihapus dari daftar hitam. {} Tidak ada, "
...
Contoh nilai waktu: 4m = 4 menit, 3h = 3 jam, 6d = 6 hari, 5w = 5 minggu.""")
            ...
            send_message(update.effective_message,
                         tl(update.effective_message, "Saya hanya mengerti off/del/warn/ban/kick/mute/tban/tmute!"))
            return ""
        if conn:
            text = tl(update.effective_message, "Mode blacklist diubah, Pengguna akan `{}` pada *{}*!").format(
        ...
        if conn:
            text = tl(update.effective_message, "Mode blacklist saat ini disetel ke *{}* pada *{}*.").format(
                settypeblacklist, chat_name)
        else:
            ...
            try:
                if getmode == 0:
                    ...
                    warn(update.effective_user, chat,
                         tl(update.effective_message, "Mengatakan kata '{}' yang ada di daftar hitam").format(trigger),
                    ...
                    bot.sendMessage(chat.id, tl(update.effective_message,
                                                "{} di bisukan karena mengatakan kata '{}' yang ada di daftar hitam").format(
                        mention_markdown(user.id, user.first_name), trigger), parse_mode="markdown")
                    return
                elif getmode == 4:
                    message.delete()
                    ...
                    if res:
                        bot.sendMessage(chat.id, tl(update.effective_message,
                                                    "{} di tendang karena mengatakan kata '{}' yang ada di daftar hitam").format(
                            mention_markdown(user.id, user.first_name), trigger), parse_mode="markdown")
                    return
                elif getmode == 5:
                    message.delete()
                    ...
                    bot.sendMessage(chat.id, tl(update.effective_message,
                                                "{} di blokir karena mengatakan kata '{}' yang ada di daftar hitam").format(
                        mention_markdown(user.id, user.first_name), trigger), parse_mode="markdown")
                    return
                elif getmode == 6:
                    message.delete()
                    ...
                    bot.sendMessage(chat.id, tl(update.effective_message,
                                                "{} di blokir selama {} karena mengatakan kata '{}' yang ada di daftar hitam").format(
                        mention_markdown(user.id, user.first_name), value, trigger), parse_mode="markdown")
                    return
                elif getmode == 7:
                    message.delete()
                    ...
                    bot.sendMessage(chat.id, tl(update.effective_message,
                                                "{} di bisukan selama {} karena mengatakan kata '{}' yang ada di daftar hitam").format(
                        mention_markdown(user.id, user.first_name), value, trigger), parse_mode="markdown")
                    return
