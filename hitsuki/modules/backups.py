...
from hitsuki import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, spamfilters, TEMPORARY_DATA
...
def import_data(bot: Bot, update):
	...
	if msg.reply_to_message and msg.reply_to_message.document:
		...
		try:
			...
			send_message(update.effective_message, tl(update.effective_message, "Telah terjadi kesalahan dalam import backup Hitsuki!"), parse_mode="markdown")
