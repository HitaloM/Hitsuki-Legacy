...
class WelcomeSecurity(BASE):
    ...
    def __init__(self, chat_id, security=False, extra_verify=False, mute_time="0", timeout="0", timeout_mode=1,
...
def set_welcome_security(chat_id, security, extra_verify, mute_time, timeout, timeout_mode, custom_text):
    with WS_LOCK:
        ...
        if not curr_setting:
            curr_setting = WelcomeSecurity(chat_id, security=security, extra_verify=extra_verify, mute_time=mute_time,
                                           timeout=timeout, timeout_mode=timeout_mode, custom_text=custom_text)
