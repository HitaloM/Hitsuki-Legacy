...
def new_add_filter(chat_id, keyword, reply_text, file_type, file_id, buttons):
    ...
    with CUST_FILT_LOCK:
        ...
        filt = CustomFilters(str(chat_id), keyword, reply="there is should be a new reply", is_sticker=False,
                             is_document=False, is_image=False, is_audio=False, is_voice=False, is_video=False,
                             has_buttons=bool(buttons), reply_text=reply_text, file_type=file_type.value,
                             file_id=file_id)
