    ...
    class DisableAbleCommandHandler(CommandHandler):
        ...
        def check_update(self, update):
            if isinstance(update, Update) and update.effective_message:
                ...
                if message.text and len(message.text) > 1 and any(
                        message.text.startswith(start) for start in CMD_STARTERS):
    ...
    def disable(update, context):
        ...
        if len(args) >= 1:
            ...
            if disable_cmd in set(DISABLE_CMDS + DISABLE_OTHER):
                ...
                if conn:
                    text = languages.tl(update.effective_message, "Menonaktifkan penggunaan `{}` pada *{}*").format(
                ...
                send_message(update.effective_message,
                             languages.tl(update.effective_message, "Perintah itu tidak bisa dinonaktifkan"))
    ...
    def enable(update, context):
        ...
        if len(args) >= 1:
            ...
            if sql.enable_command(chat.id, enable_cmd):
                if conn:
                    text = languages.tl(update.effective_message, "Diaktifkan penggunaan `{}` pada *{}*").format(
                ...
                send_message(update.effective_message,
                             languages.tl(update.effective_message, "Apakah itu bahkan dinonaktifkan?"))
