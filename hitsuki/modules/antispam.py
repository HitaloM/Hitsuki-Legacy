...
from hitsuki import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, GBAN_DUMP, STRICT_ANTISPAM, sw
...
def __stats__():
    return "• <code>{}</code> gbanned users [We regularly clean off deleted account from the database].".format(
