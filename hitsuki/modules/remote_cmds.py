...
def rban(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        ...
        message.reply_text(
            "Uhhh, which chat am I supposed to ban them from bud?")
        return
    ...
    try:
        ...
        if excp.message == "Chat not found":
            message.reply_text(
                "Either you fucked up typing the chat ID, or I'm not in this group.")
            return
        else:
            raise
    ...
    if chat.type == 'private':
        message.reply_text(
            "Sorry fam this is a Christian group, no bans allowed.")
        return

    if not is_bot_admin(
            chat, bot.id) or not chat.get_member(
...
def runban(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        ...
        message.reply_text(
            "Uhhh, which chat am I supposed to unban them from bud?")
        return
    ...
    if chat.type == 'private':
        message.reply_text(
            "Sorry fam this is a Christian group, no unbans allowed.")
        return
    ...
    if is_user_in_chat(chat, user_id):
        message.reply_text(
            "Uhh, they're already in the group... No need to unban them.")
        return
...
def rkick(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        ...
        message.reply_text(
            "Uhhh, which chat am I supposed to kick them from bud?")
        return
    ...
    if chat.type == 'private':
        message.reply_text(
            "Sorry fam this is a Christian group, no kicking allowed.")
        return
    ...
    if is_user_ban_protected(chat, user_id, member):
        message.reply_text(
            "Sir pls, this guy is an admeme. I can't kick them!")
        return
...
def rmute(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        ...
        message.reply_text(
            "Uhhh, which chat am I supposed to mute them from bud?")
        return
    ...
    if chat.type == 'private':
        message.reply_text(
            "Sorry fam this is a Christian group, no muting allowed.")
        return
    ...
    if is_user_ban_protected(chat, user_id, member):
        message.reply_text(
            "Sir pls, this guy is an admeme. I can't mute them!")
        return
...
def runmute(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        ...
        message.reply_text(
            "Uhhh, which chat am I supposed to unmute them from bud?")
        return
    ...
    if chat.type == 'private':
        message.reply_text(
            "Sorry fam this is a Christian group, no unmuting allowed.")
        return
    ...
    if is_user_in_chat(chat, user_id):
        if member.can_send_messages and member.can_send_media_messages \
           and member.can_send_other_messages and member.can_add_web_page_previews:
            message.reply_text(
                "You want them to yell or something? they're not muted to begin with.")
            return
