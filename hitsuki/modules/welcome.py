...
try:
	from hitsuki import SPAMWATCH_TOKEN
except:
	pass
	...
	if json.get("ok"):
		if json["result"]["offenses"] > 0:
			...
			if fed_id:
				...
				bot.sendMessage(-1001332080671, text, parse_mode="markdown", disable_web_page_preview=True)
