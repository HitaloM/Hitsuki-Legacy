...
# admin
	...
	"How am I going to demote someone who hasn't been promoted?": "Como vou rebaixar alguém que não foi promovido?",
	"This person CREATED the chat, how would I demote them?": "Essa pessoa CRIOU o grupo, como você 3spera que eu rebaixe ela?",
	"Tidak dapat menurunkan jabatan apa yang tidak dipromosikan!": "Can't demote what wasn't promoted!",
	"I can't demote myself! Get an admin to do it for me.": "não irei me rebaixar! Fale com um administrador para fazer isso por mim.",
	...
	"Use /pin <notify/loud/silent/violent> <message link>": "Use /pin <notify/loud/silent/violent> <linda da mensagem>",
	"Reply to a message for pin that message in this group": "Responda uma mensagem para que eu fixe ele neste grupo.",
	"I have pinned messages in the group {}": "Eu fixei uma mensagem no grupo {}",
	"I have unpin the message in the group {}": "Eu desafixei uma mensagem no grupo {}",
	"I don't have access to the invite link, try changing my permissions!": "Eu não tenho acesso ao link de convite deste grupo, tente alterar minhas permissões!",
	"I can only give you invite links for supergroups and channels, sorry!": "Eu posso apenas te dar links de convite para super grupos e canais, desculpe!",
	"Admin in *{}*:": "Admins em *{}*:",
	"chat ini": "current chat",
	"☠ Deleted Account": "☠ Conta Excluída",
	"Wrong markdown text!\nIf you don't know what markdown is, please type `/markdownhelp` in PM.": "Markdown errado!\nSe você não sabe o que markdown é, por favor, digite `/markdownhelp` no privado.",
	"I don't have access to pin message!": "Eu não tenho permissão para ficar mensagens!",
	"\n\nYou are *{}*": "\n\nVocê é *{}*",
	"Current permanent pin: `{}`": "Permanentpin atual: `{}`",
...
# Bans
	...
	"You have no right to restrict someone.": "Você não tem o direito de restringir alguém.",
	"Banned at *{}*! 😝": "Banido em *{}*! 😝",
	"Kicked in *{}*! 😝": "Removido em *{}*! 😝",
	"Banned! 😝": "Banido! 😝",
	"Kicked! 😝": "Removido! 😝",
...
# muting
	"You'll need to either give me a username to mute, or reply to someone to be muted.": "Você precisa me dar um nome de usuário para eu silenciar, ou responder a alguém para ser silenciado.",
	"Muted on *{}*! 😆": "Silenciado em *{}* 😆",
	"Muted! 😆": "Silenciado 😆",
	"He has been unmuted.": "Certo, ele pode falar novamente.",
	"I'm not muting myself!": "Eu não irei me silenciar!",
	"Afraid I can't stop an admin from talking!": "Eu não posso impedir um administrador de falar!",
	"This user is already muted!": "Este usuário já está silenciado!",
